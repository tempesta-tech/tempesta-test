...
# Deproxy response content size in bytes
LARGE_CONTENT_LENGTH = 1024 * 64 * 1024

# Deproxy server config with large response
DEPROXY_CONFIG = {
    'id': 'deproxy',
    'type': 'deproxy',
    'port': '8000',
...
class H2LoadStress(CustomMtuMixin, tester.TempestaTest):
    """
