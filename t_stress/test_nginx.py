...
from t_stress.test_stress import BaseCurlStress, BaseWrkStress, LargePageNginxBackendMixin
...
class NginxWrkStress(NginxProxyMixin, LargePageNginxBackendMixin, BaseWrkStress):
...
class NginxTlsWrkStress(NginxProxyMixin, LargePageNginxBackendMixin, BaseWrkStress):
