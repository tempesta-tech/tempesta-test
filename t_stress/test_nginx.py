...
class NginxWrkStress(NginxProxyMixin, BaseWrkStress):
...
class NginxTlsWrkStress(NginxProxyMixin, BaseWrkStress):
...
class NginxCurlStress(NginxProxyMixin, BaseCurlStress):
    ...
    def setUp(self):
        self.clients = [{**client, "addr": "${general_ip}"} for client in self.clients]
        super().setUp()
...
class NginxTlsCurlStress(NginxProxyMixin, BaseCurlStress):
    ...
    def setUp(self):
        ...
        self.clients = [{**client, "addr": "${general_ip}:443"} for client in self.clients]
        super().setUp()
