...
""",
    ...
    def test_two_clients_one_ip(self):
        ...
        self.assertFalse(deproxy_cl.connection_is_closed())#I don't know why the connection is not closed,it should be closed
        self.assertFalse(deproxy_cl2.connection_is_closed())#I don't know why the connection is not closed,it should be closed