...
""",
    ...
    clients = [
        ...
        {"id": "deproxy3", "type": "deproxy", "addr": "${tempesta_ip}", "port": "80"},
        {"id": "deproxy4", "type": "deproxy", "addr": "${tempesta_ip}", "port": "80"},
    ]
...
""",
    ...
    def test_zero_value_limit(self):
        ...
        self.assertEqual(klog.warn_count(ERROR), 0, "Frang limits warning was shown")
