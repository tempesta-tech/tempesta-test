...
""",
    ...
    def test_on(self):
        ...
        c2.make_req_wait_resp(self.BAD_REQ)
        ...
        c5.start()
        c5.make_req_wait_resp(self.GOOD_REQ)
...
""",
        ...
        # handled separately
        c1.make_req_wait_resp(self.BAD_REQ)
...
""",
    ...
    def test_on(self):
        ...
        four.make_req_wait_resp(self.REQ)
        ...
        # New clients with blocked IP won't be accepted
        c5.start()
        c5.make_req_wait_resp(self.REQ)
        self.assertFalse(c5.conn_is_active)
...
""",
        ...
        c3.make_req_wait_resp(self.REQ)
