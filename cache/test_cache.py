...
""",
    ...
    def test(self):
        ...
        client = self.get_client("deproxy")
        # First request with Referer goes to app1 (server deproxy, body "a" * 10)
        client.send_request(
        ...
        # Second request with same Referer - should be cached
        client.send_request(
            client.create_request(
                method="GET",
                uri="/",
        ...
        # Third request without Referer goes to app2 (server deproxy_extra, body "a" * 11)
        client.send_request(
            client.create_request(
                method="GET",
                uri="/",
