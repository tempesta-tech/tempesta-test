...
class DeproxyEchoServer(deproxy_server.StaticDeproxyServer):
    ...
    def __remove_keep_alive_header(self) -> str:
        return re.sub(r"Connection: .*$", "", self.response.decode(), flags=re.MULTILINE)
    ...
    def _receive_request(
        ...
        response = deproxy_message.Response(self.__remove_keep_alive_header())
