...
class TestH2CacheControl(TestH2CacheBase):
    ...
    # MAX-AGE -------------------------------------------------------------------------------------
    async def test_max_age_0_in_request(self):
    ...
    async def test_max_age_1_in_request_sleep_2(self):
    ...
    async def test_max_age_1_in_request_sleep_2_from_hpack_dynamic_table(self):
        """
    ...
    async def test_max_age_2_in_request_sleep_0(self):
    ...
    async def test_max_age_0_in_response(self):
        """Response must not be from cache if max-age=0."""
        await self.base_scenario(
    ...
    async def test_max_age_1_in_response_sleep_2(self):
        """Response must not be from cache if sleep > max-age."""
        await self.base_scenario(
    ...
    async def test_max_age_2_in_response_sleep_0(self):
        """Response must be from cache if sleep < max-age."""
        await self.base_scenario(
    ...
    # S-MAXAGE ------------------------------------------------------------------------------------
    async def test_s_maxage_in_request(self):
    ...
    async def test_s_maxage_0_in_response(self):
    ...
    async def test_s_maxage_1_in_response_sleep_2(self):
    ...
    async def test_s_maxage_2_in_response_sleep_0(self):
    ...
    async def test_s_maxage_in_response_and_max_stale_in_request(self):
        """
    ...
    async def test_s_maxage_1_max_age_5_in_response_sleep_2(self):
    ...
    # MAX-STALE -----------------------------------------------------------------------------------
    async def test_max_stale_1_in_request_sleep_3(self):
    ...
    async def test_max_stale_5_in_request_sleep_2(self):
    ...
    async def test_max_stale_5_in_request_sleep_2_from_dynamic_table(self):
        """
    ...
    async def test_max_stale_in_request_sleep_2(self):
    ...
    # MIN-FRESH -----------------------------------------------------------------------------------
    async def test_min_fresh_2_in_request_sleep_2(self):
    ...
    async def test_min_fresh_1_in_request_sleep_0(self):
    ...
    async def test_min_fresh_1_in_request_sleep_0_from_dynamic_table(self):
        """
    ...
    # ONLY-IF-CACHED ------------------------------------------------------------------------------
    async def test_only_if_cached_in_request_from_cache(self):
    ...
    async def test_only_if_cached_in_request_from_cache_from_dynamic_table(self):
        """
        Same as previous but second only-if-cache header is loaded
        from hpack dynamic table.
        """
        await self.test_only_if_cached_in_request_from_cache()
        client = self.get_client("deproxy")
        server = self.get_server("deproxy")
        await client.send_request(
            client.create_request(
    ...
    async def test_only_if_cached_in_request_not_from_cache(self):
        """Tempesta must return a 504 status code if response is not from cache."""
        await self.base_scenario(
            response_headers=[("cache-control", "max-age=1")],
            request_headers=[],
    ...
    # NO-STORE ------------------------------------------------------------------------------------
    async def test_no_store_in_first_request(self):
    ...
    async def test_no_store_in_first_and_second_request_from_dynamic_table(self):
        """
    ...
    async def test_no_store_in_second_request(self):
        """
    ...
    async def test_no_store_in_response(self):
    ...
    # NO-CACHE ------------------------------------------------------------------------------------
    async def test_no_cache_in_first_request(self):
    ...
    async def test_no_cache_in_second_request(self):
    ...
    async def test_no_cache_in_response(self):
    ...
    # MUST-REVALIDATE -----------------------------------------------------------------------------
    async def test_must_revalidate_in_response_not_from_cache(self):
        """
        Response must not be from cache if:
    ...
    async def test_must_revalidate_in_response_from_cache(self):
        """
    ...
    async def test_must_revalidate_in_response_max_stale_in_request_not_from_cache(self):
        """
        Response must not be from cache if:
            - must-revalidate is present in response;
            - max-stale is present in request;
    ...
    async def test_must_revalidate_in_response_max_stale_in_request_from_cache(self):
        """
        Response must be from cache if:
            - must-revalidate is present in response;
            - max-stale is present in request;
    ...
    # PROXY-REVALIDATE ----------------------------------------------------------------------------
    async def test_proxy_revalidate_in_response_not_from_cache(self):
        """
        Response must not be from cache if:
            - must-revalidate is present in response;
            - sleep > max-age;
    ...
    async def test_proxy_revalidate_in_response_from_cache(self):
        """
        Response must be from cache if:
    ...
    async def test_proxy_revalidate_in_response_max_stale_in_request_not_from_cache(self):
        """
        Response must not be from cache if:
            - proxy-revalidate is present in response;
            - max-stale is present in request;
    ...
    async def test_proxy_revalidate_in_response_max_stale_in_request_from_cache(self):
        """
        Response must be from cache if:
            - proxy-revalidate is present in response;
            - max-stale is present in request;
    ...
    # PRIVATE -------------------------------------------------------------------------------------
    async def test_private_in_response(self):
    ...
    # AUTHORIZATION -------------------------------------------------------------------------------
    async def test_authorization_in_first_request_s_maxage_in_response(self):
        """
    ...
    async def test_authorization_in_first_request_public_in_response(self):
        """
        Response must be cached if:
            - authorization header is present in request;
    ...
    async def test_authorization_in_first_request_must_revalidate_in_response(self):
        """
        Response must be cached if:
            - authorization header is present in request;
            - must-revalidate is present in response;
    ...
    async def test_authorization_in_first_request_proxy_revalidate_in_response(self):
        """
    ...
    async def test_same_authorization_in_requests_max_age_in_response(self):
        """
    ...
    async def test_same_authorization_in_requests_no_transform_in_response(self):
        """
        Response must not be cached if same authorization header is present in request.
        RFC 9111 3.5
        """
    ...
    async def test_same_authorization_in_requests(self):
        """
        Response must not be cached if same authorization header is present in request.
        RFC 9111 3.5
        """
    ...
    async def test_same_authorization_in_requests_from_dynamic_table(self):
        """
        Same as previous but second authorization header is loaded
        from hpack dynamic table.
        """
        await self.test_same_authorization_in_requests()
        server = self.get_server("deproxy")
        client = self.get_client("deproxy")
        await client.send_request(
            client.create_request(
    ...
    async def test_authorization_in_second_request(self):
        """
    ...
    # COOKIE --------------------------------------------------------------------------------------
    async def test_set_cookie_no_cached(self):
        """
...
"""
    ...
    async def test_ignore_must_revalidate(self):
        await self.base_scenario(
    ...
    async def test_multi_ignore_private_no_cache_no_store(self):
        await self.base_scenario(
    ...
    async def test_ignore_public_with_authorization(self):
        await self.base_scenario(
    ...
    async def test_ignore_max_age_s_maxage(self):
        await self.base_scenario(
    ...
    async def test_ignore_max_age_not_ignore_s_maxage(self):
        await self.base_scenario(
    ...
    async def test_ignore_max_stale_in_request(self):
        await self.base_scenario(
