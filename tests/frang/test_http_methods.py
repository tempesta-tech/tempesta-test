...
class FrangHttpMethodsTestCase(FrangTestCase):
    ...
    async def test_not_accepted_request(self):
        client = self.get_client("deproxy-1")
        client = await self.base_scenario(
    ...
    async def test_accepted_request_shipping_cfg(self):
        client = self.get_client("deproxy-1")
        client = await self.base_scenario(
    ...
    async def test_not_accepted_request_shipping_cfg(self, name):
        """
    ...
    async def test_not_accepted_request_register(self):
    ...
    async def test_not_accepted_request_with_unknown_method(self):
        client = self.get_client("deproxy-1")
        client = await self.base_scenario(
            frang_config="http_methods get post;",
    ...
    async def test_accepted_request_with_unknown_method(self):
        client = self.get_client("deproxy-1")
        client = await self.base_scenario(
    ...
    async def test_not_accepted_request_owerride(self):
        client = self.get_client("deproxy-1")
        client = await self.base_scenario(
            frang_config="http_methods get post;",
            requests=[
...
class FrangHttpMethodsH2(H2Config, FrangHttpMethodsTestCase):
    ...
    async def test_not_accepted_request_zero_byte(self):
        self.disable_deproxy_auto_parser()
        client = await self.base_scenario(
            frang_config="http_methods get post;",
            requests=[
        ...
        await self.check_response(client, status_code="400", warning_msg="HTTP/2 request dropped:")
