...
class FrangHttpMethodsOverrideTestCase(FrangTestCase):
    ...
    async def test_not_accepted_request_x_http_method_override(self):
        """
        ...
        await self.check_response(client, status_code="403", warning_msg=WARN_ERROR)

    async def test_not_accepted_request_x_method_override(self):
        """
        override methods not allowed by limit http_methods
    ...
    async def test_not_accepted_request_x_http_method(self):
        """
        override methods not allowed by limit http_methods
        for X_HTTP_METHOD
        """
    ...
    async def test_unsafe_override_x_http_method_override(self):
        """
        ...
        await self.check_response(client, status_code="400", warning_msg=WARN_UNSAFE)

    async def test_unsafe_override_x_http_method(self):
        """
        should not be allowed to be overridden by unsafe methods
        for X-HTTP-Method
        """
    ...
    async def test_unsafe_override_x_method_override(self):
        """
        should not be allowed to be overridden by unsafe methods
    ...
    async def test_default_http_method_override_allowed(self):
