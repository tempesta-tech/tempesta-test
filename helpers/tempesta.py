...
class Stats(object):
    ...
    def clear(self):
        ...
        self.cl_rx_bytes = 0
        self.cl_prio_frame_exceeded = 0
        self.cl_rst_stream_frame_exceeded = 0
    ...
    def parse(self, stats):
        ...
        self.cl_prio_frame_exceeded = self.parse_option(stats, "Client priority frames number exceeded")
        self.cl_rst_stream_frame_exceeded = self.parse_option(stats, "Client rst stream frames number exceeded")
